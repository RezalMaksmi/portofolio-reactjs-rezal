...
const Aboutme = () => {                
  ...
  return (
    ...
    <div className='bg-white dark:bg-[#2B2B2B] w-full' id='about'>
      <div className="container max-w-7xl  h-auto m-auto flex flex-col md:flex-row justify-between gap-10 md:px-10 px-4 relative">
        <div className='max-w-6xl w-full overflow-hidden bg-white dark:bg-[#565656] rounded-2xl h-auto drop-shadow-3xl py-10 md:p-14 px-6 relative top-0'>
            <div className='relative w-full dark:text-white '>
                ...
                <span className='text-base leading-[8px]'>I am a student in Malang, East Java, who is currently studying for bachelor's degree, I am here focusing on making websites on the frontend.</span>
            </div>
                  ...
                  // 
                    skillMe.map(skill => {
                        ...
                        <div className='mt-7'>
                            ...
                            <div className='w-full sm:h-4 h-3 mt-3 bg-slate-400 rounded-full overflow-hidden'><div className='bg-slate-900 h-full animate__slideInLeft' id='skillValue' style={{width: `${skill.value}`,}}></div></div>
                        </div>
                        )
                    })
                }
